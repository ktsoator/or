...
func TestBuildAssemblesTaskRequestsAndToolResults(t *testing.T) {
	...
	report := observability.DiagnosticReport{
		...
		Runs: []observability.DiagnosticRun{
			diagnosticRun("run-1", base, []observability.DiagnosticEvent{
				{Name: observability.TurnStarted, Timestamp: base, TurnID: "turn-parent", Status: "running"},
				{Name: observability.StepStarted, Timestamp: base, TurnID: "turn-parent", StepID: "step-1", Status: "running"},
				{Name: observability.CheckpointCompleted, Timestamp: base.Add(10 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", Status: "completed", DurationMS: 10},
				{Name: observability.ProviderStarted, Timestamp: base.Add(10 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", Provider: "openai", Model: "gpt-5", Status: "running"},
				{Name: observability.HTTPAttemptStarted, Timestamp: base.Add(20 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", AttemptID: "attempt-1", Attempt: 1, Status: "running"},
				{Name: observability.HTTPAttemptResponse, Timestamp: base.Add(100 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", AttemptID: "attempt-1", Attempt: 1, HTTPStatus: 200, Status: "completed", DurationMS: 80},
				{Name: observability.ProviderCompleted, Timestamp: base.Add(2 * time.Second), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", Provider: "openai", Model: "gpt-5", Status: "completed", DurationMS: 1990, TimeToFirstOutputMS: 900, InputTokens: 100, OutputTokens: 30, TotalTokens: 130},
				{Name: observability.ToolStarted, Timestamp: base.Add(2010 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", ToolCallID: "call-1", ToolName: "write", Status: "running"},
				{Name: observability.ApprovalStarted, Timestamp: base.Add(2020 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", ToolCallID: "call-1", ToolName: "write", Status: "waiting"},
				{Name: observability.ApprovalCompleted, Timestamp: base.Add(2120 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", ToolCallID: "call-1", ToolName: "write", Status: "allowed", DurationMS: 100},
				{Name: observability.ToolCompleted, Timestamp: base.Add(2210 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", ToolCallID: "call-1", ToolName: "write", Status: "success", DurationMS: 200},
				{Name: observability.StepCompleted, Timestamp: base.Add(2220 * time.Millisecond), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", Status: "completed", DurationMS: 2220},
				{Name: observability.StepStarted, Timestamp: base.Add(2300 * time.Millisecond), TurnID: "turn-parent", StepID: "step-2", Status: "running"},
				{Name: observability.ProviderStarted, Timestamp: base.Add(2300 * time.Millisecond), TurnID: "turn-parent", StepID: "step-2", ProviderRequestID: "request-2", Provider: "openai", Model: "gpt-5", Status: "running"},
				{Name: observability.ProviderCompleted, Timestamp: base.Add(3 * time.Second), TurnID: "turn-parent", StepID: "step-2", ProviderRequestID: "request-2", Provider: "openai", Model: "gpt-5", Status: "completed", DurationMS: 700, TimeToFirstOutputMS: 400, InputTokens: 140, OutputTokens: 15, TotalTokens: 155},
			}),
	...
	if first.Number != 2 || first.TurnID != "turn-parent" || first.StepID != "step-1" ||
		first.SnapshotState != SnapshotAvailable || first.CheckpointDurationMS != 10 {
		t.Fatalf("first request = %#v", first)
	}
	if len(first.Attempts) != 1 || first.Attempts[0].ID != "attempt-1" ||
		first.Attempts[0].HTTPStatus != 200 {
...
func TestBuildCompletesSnapshotToolWhenRequestIsCancelled(t *testing.T) {
	...
	report := observability.DiagnosticReport{Runs: []observability.DiagnosticRun{
		diagnosticRun("run-1", base, []observability.DiagnosticEvent{
			{Name: observability.ProviderStarted, Timestamp: base, TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", Status: "running"},
			{Name: observability.ProviderFailed, Timestamp: base.Add(2 * time.Second), TurnID: "turn-parent", StepID: "step-1", ProviderRequestID: "request-1", Status: "cancelled", ErrorCode: "context_cancelled", DurationMS: 2000},
		}),
	}}
