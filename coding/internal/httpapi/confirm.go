...
// ConfirmBroker implements permission.Confirm for the HTTP API. It pushes a
...
// answered. It satisfies permission.Confirm.
func (b *ConfirmBroker) Confirm(req permission.Request) bool {
...
// confirmation prompt.
func describe(req permission.Request) string {
	switch req.Tool {
	case "bash":
